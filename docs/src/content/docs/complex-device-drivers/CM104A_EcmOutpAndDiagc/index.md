---
title: "Engine Control Module Output And Diagnostics (CM104A_EcmOutpAndDiagc)"
description: "Engine Control Module Output And Diagnostics: purpose, files, interfaces and reference documents."
---
...
The Engine Control Module Output And Diagnostics component belongs to **System, Memory and Startup** in the **Complex Device Drivers** layer. It configures or supervises microcontroller cores, guards, clocks, flash and RAM, or the startup sequence.
...
| Directory | Role |
|---|---|
| `CM104A_EcmOutpAndDiagc_Design` | Design package |
| `CM104A_EcmOutpAndDiagc_Impl` | Implementation package |

## Key files

| Area | Files |
|---|---|
| `CM104A_EcmOutpAndDiagc_Design` |  |
| Documentation folders | `Doc/`, `Design/`, `Reports/` |
| `CM104A_EcmOutpAndDiagc_Impl` |  |
| C sources | `CDD_EcmOutpAndDiagc.c`, `CDD_EcmOutpAndDiagcNonRte.c` |
| Public headers | `CDD_EcmOutpAndDiagc.h` |
| AUTOSAR model | `AUTOSAR_4-0-3.xsd`, `DataTypes.arxml`, `DataTypes_gen_attr.xml`, `EcmOutpAndDiagc.dcf`, `EcmOutpAndDiagc_attr_def.xml`, `Packages.arxml`, `Packages_gen_attr.xml`, `PortInterfaces.arxml`, `PortInterfaces_gen_attr.xml`, `ProfileSettings.xml` |
| Tooling and integration scripts | `CM104A_EcmOutpAndDiagc_Impl.gpj`, `Component.ecuc.arxml`, `Component_Rte_ecuc.arxml`, `CreateGHSProject.bat`, `CreateQACProject.bat`, `EcmOutpAndDiagc.dpa`, `RteGen.bat` |
| Documentation folders | `doc/` |

## Public interface and usage

The component interface is modelled in AUTOSAR XML (3 file(s), e.g. `CM104A_EcmOutpAndDiagc_Impl/autosar/DataTypes.arxml`); the Runtime Environment generates the callable interface from this model. 
Implementation lives in 2 C source file(s), starting with `CM104A_EcmOutpAndDiagc_Impl/src/CDD_EcmOutpAndDiagc.c`. 
No top-level function definitions were extracted from the main source file; consult the source and the integration manual below.

Additional implementation units: `CM104A_EcmOutpAndDiagc_Impl/src/CDD_EcmOutpAndDiagcNonRte.c`.
...
### `CM104A_EcmOutpAndDiagc.doc`

- **Source path in repository:** `CM104A_EcmOutpAndDiagc_Design/Design/CM104A_EcmOutpAndDiagc.doc`
- **Format:** `.doc`
- **Size:** `672 KiB`
...
### `CM104A_EcmOutpAndDiagc_DDReport.txt`

- **Source path in repository:** `CM104A_EcmOutpAndDiagc_Design/Reports/CM104A_EcmOutpAndDiagc_DDReport.txt`
- **Format:** `.txt`
- **Size:** `4 KiB`
- **Expected content:** Reference document (inferred from the file name — assumption).
...
### `EcmOutpAndDiagc Integration Manual.doc`

- **Source path in repository:** `CM104A_EcmOutpAndDiagc_Impl/doc/EcmOutpAndDiagc Integration Manual.doc`
- **Format:** `.doc`
- **Size:** `146 KiB`
...
### `EcmOutpAndDiagc Module Design Document.docx`

- **Source path in repository:** `CM104A_EcmOutpAndDiagc_Impl/doc/EcmOutpAndDiagc Module Design Document.docx`
- **Format:** `.docx`
- **Size:** `98 KiB`
- **Expected content:** Reference document (inferred from the file name — assumption).
...
| Updated with startup tests for EI and Pseudo Error Injection | Avinash  James | 2 | 02/0 5 /15 |
