---
title: "Tauj0 Configuration And Use (CM455A_Tauj0CfgAndUse)"
description: "Tauj0 Configuration And Use: purpose, files, interfaces and reference documents."
---
...
The Tauj0 Configuration And Use component belongs to **Analog Acquisition and Timers** in the **Complex Device Drivers** layer. It configures analog-to-digital converters, sensor-measurement triggering or hardware timers.
...
| Directory | Role |
|---|---|
| `CM455A_Tauj0CfgAndUse_Design` | Design package |
| `CM455A_Tauj0CfgAndUse_Impl` | Implementation package |

## Key files

| Area | Files |
|---|---|
| `CM455A_Tauj0CfgAndUse_Design` |  |
| Documentation folders | `Doc/`, `Design/`, `Reports/` |
| `CM455A_Tauj0CfgAndUse_Impl` |  |
| C sources | `CDD_Tauj0CfgAndUse.c` |
| AUTOSAR model | `AUTOSAR_4-0-3.xsd`, `DataTypes.arxml`, `DataTypes_gen_attr.xml`, `Packages.arxml`, `Packages_gen_attr.xml`, `PortInterfaces.arxml`, `PortInterfaces_gen_attr.xml`, `ProfileSettings.xml`, `Tauj0CfgAndUse.dcf`, `Tauj0CfgAndUse_attr_def.xml` |
| Tooling and integration scripts | `CM455A_Tauj0CfgAndUse_Impl.gpj`, `Component.ecuc.arxml`, `Component_Rte_ecuc.arxml`, `CreateGHSProject.bat`, `CreatePolyspaceProject.bat`, `CreateQACProject.bat`, `RteGen.bat`, `Tauj0CfgAndUse.dpa` |
| Documentation folders | `doc/` |

## Public interface and usage

The component interface is modelled in AUTOSAR XML (3 file(s), e.g. `CM455A_Tauj0CfgAndUse_Impl/autosar/DataTypes.arxml`); the Runtime Environment generates the callable interface from this model. 
Implementation lives in 1 C source file(s), starting with `CM455A_Tauj0CfgAndUse_Impl/src/CDD_Tauj0CfgAndUse.c`. 
...
- **Source path in repository:** `CM455A_Tauj0CfgAndUse_Design/Doc/Tauj0 Registers.txt`
- **Format:** `.txt`
- **Size:** `76 KiB`
...
### `CM455A_Tauj0CfgAndUse_DDReport.txt`

- **Source path in repository:** `CM455A_Tauj0CfgAndUse_Design/Reports/CM455A_Tauj0CfgAndUse_DDReport.txt`
- **Format:** `.txt`
- **Size:** `5 KiB`
- **Expected content:** Reference document (inferred from the file name — assumption).
...
### `Tauj0CfgAndUse_IntegrationManual.doc`

- **Source path in repository:** `CM455A_Tauj0CfgAndUse_Impl/doc/Tauj0CfgAndUse_IntegrationManual.doc`
- **Format:** `.doc`
- **Size:** `140 KiB`
...
### `Tauj0CfgAndUse_MDD.docx`

- **Source path in repository:** `CM455A_Tauj0CfgAndUse_Impl/doc/Tauj0CfgAndUse_MDD.docx`
- **Format:** `.docx`
- **Size:** `107 KiB`
...
2Tauj0CfgAndUse High-Level Description5

3Design details of software module6

3.1Graphical representation of ‘Tauj0CfgAndUse’6
...
5.1.1Init: Tauj0CfgAndUseInit18

5.1.1.1Design Rationale8

5.1.1.2Module Outputs8

5.1.2Per: Tauj0CfgAndUsePer18
...
| 5 | FDD :  CM455A _ Tauj0CfgAndUse _Design | See Synergy sub project version |
