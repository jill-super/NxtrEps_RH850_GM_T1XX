---
title: "Motor Ripple Cogging Configuration (SF106A_MotRplCoggCfg)"
description: "Motor Ripple Cogging Configuration: purpose, files, interfaces and reference documents."
---
...
The Motor Ripple Cogging Configuration component belongs to **Steering Functions** in the **Application Software** layer. It implements one steering-control feature (assist, damping, return, compensation or protection) as an AUTOSAR software component.
...
| Directory | Role |
|---|---|
| `SF106A_MotRplCoggCfg_Design` | Design package |
| `SF106A_MotRplCoggCfg_Impl` | Implementation package |
...
| `SF106A_MotRplCoggCfg_Impl` |  |
| C sources | `MotRplCoggCfg.c` |
| AUTOSAR model | `AUTOSAR_4-0-3.xsd`, `DataTypes.arxml`, `DataTypes_gen_attr.xml`, `MotRplCoggCfg.dcf`, `MotRplCoggCfg_attr_def.xml`, `Packages.arxml`, `Packages_gen_attr.xml`, `PortInterfaces.arxml`, `PortInterfaces_gen_attr.xml`, `ProfileSettings.xml` |
| Tooling and integration scripts | `Component.ecuc.arxml`, `Component_Rte_ecuc.arxml`, `CreateGHSProject.bat`, `CreatePolyspaceProject.bat`, `CreateQACProject.bat`, `MotRplCoggCfg.dpa`, `RteGen.bat`, `SF106A_MotRplCoggCfg_Impl.gpj` |
| Documentation folders | `doc/` |

## Public interface and usage

The component interface is modelled in AUTOSAR XML (3 file(s), e.g. `SF106A_MotRplCoggCfg_Impl/autosar/DataTypes.arxml`); the Runtime Environment generates the callable interface from this model. 
Implementation lives in 1 C source file(s), starting with `SF106A_MotRplCoggCfg_Impl/src/MotRplCoggCfg.c`. 
...
### `SF106A_MotRplCoggCfg_DDReport.txt`

- **Source path in repository:** `SF106A_MotRplCoggCfg_Design/Reports/SF106A_MotRplCoggCfg_DDReport.txt`
- **Format:** `.txt`
- **Size:** `4 KiB`
...
```text
Verification of SF106A_MotRplCoggCfg_DataDict
13-May-2016 10:27:37
Tool Release:  2.39.0
...
### `MotRplCoggCfg_IntegrationManual.doc`

- **Source path in repository:** `SF106A_MotRplCoggCfg_Impl/doc/MotRplCoggCfg_IntegrationManual.doc`
- **Format:** `.doc`
- **Size:** `151 KiB`
...
- **Source path in repository:** `SF106A_MotRplCoggCfg_Impl/doc/MotRplCoggCfg_MDD.docx`
- **Format:** `.docx`
- **Size:** `117 KiB`
...
2MotRplCoggCfg & High-Level Description6

3Design details of software module7

3.1Graphical representation of MotRplCoggCfg7
...
5.1.1Init: MotRplCoggCfgInit19

5.1.1.1Design Rationale9

5.1.1.2Module Outputs9

5.1.2Per: MotRplCoggCfgPer19
