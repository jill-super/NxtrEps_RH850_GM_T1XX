---
title: "Coupler Support (TL103A_CplrSuprt)"
description: "Coupler Support: purpose, files, interfaces and reference documents."
---
...
The Coupler Support component belongs to **Host Tools and Support Packages** in the **Tools and Support** layer. It is a host-side tool, generator or support package; it is not flashed onto the controller.
...
| Directory | Role |
|---|---|
| `TL103A_CplrSuprt` | Package directory |

## Key files

| Area | Files |
|---|---|
| — | (file listing unavailable; see the repository directory) |
