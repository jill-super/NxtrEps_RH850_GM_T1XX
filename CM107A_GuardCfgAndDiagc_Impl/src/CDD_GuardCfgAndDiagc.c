...
*
* Module File Name  : CDD_GuardCfgAndDiagc.c
* Module Description: Rte functions of CM107A Guard Configuration and Diagnostics RH850
* Project           : CBD
...
GuardCfgAndDiagcInit2 is an RTE function which is required for memory mapping */
