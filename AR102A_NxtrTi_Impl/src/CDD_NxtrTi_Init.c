...
* Module Description: Nexteer Time Library Initialization Function
* Project           : CBD
...
/**********************************************************************************************************************
  ...
  * Description: Non-RTE version of Nexteer Time Initialization function.  Calling this function will initialize and
