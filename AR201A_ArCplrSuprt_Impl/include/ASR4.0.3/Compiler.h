...
/* START NEXTEER PATCH: LWW 12/17/14 Updates for Renesas MCAL required defines that are not AUTOSAR standards */
#define _INTERRUPT_  __interrupt	
#define STATIC  static
/* END NEXTEER PATCH: LWW 12/17/14 Updates for Renesas MCAL required defines that are not AUTOSAR standards */
