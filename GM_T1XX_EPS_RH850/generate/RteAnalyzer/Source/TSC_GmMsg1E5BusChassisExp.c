 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  TSC_GmMsg1E5BusChassisExp.c
 *        Config:  EPS.dpa
 *   ECU-Project:  EPS
 *
...
{
  return Rte_Read_HwAgVldToSerlCom_Logl(data);
}
