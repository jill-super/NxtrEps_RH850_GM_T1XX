...
{
  return Rte_Pim_dMotCurrRegVltgLimrMotCurrCmdErr();
}
...
{
  return Rte_Pim_dMotCurrRegVltgLimrMotVltgDecouplFbDax();
}
float32 *TSC_CDD_MotCurrRegVltgLimr_Rte_Pim_dMotCurrRegVltgLimrMotVltgDecouplFbQax(void)
{
  return Rte_Pim_dMotCurrRegVltgLimrMotVltgDecouplFbQax();
}
