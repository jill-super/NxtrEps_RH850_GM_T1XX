...
{
  return Rte_Write_MotCurrRollgCntr2_Val(data);
}
...
{
  return Rte_Write_Ntc6DErrCnt_Val(data);
}
...
{
  return Rte_Read_MotAg0MeclQlfr_Val(data);
}
...
{
  return Rte_Read_MotCurrQaxToMotTqGain_Val(data);
}
